...
public class Parsing{
    public static void main(String[] args) {
        try {
            ...
            Document doc1 = dB.parse(new File("License1.xml"));
            Document doc2 = dB.parse(new File("License2.xml"));

            NodeList nodeList1 = doc1.getElementsByTagName("License");
            NodeList nodeList2 = doc2.getElementsByTagName("License");

            BufferedWriter validLicenseWriter = new BufferedWriter(new FileWriter("ValidLicenses.csv"));
            BufferedWriter invalidLicenseWriter = new BufferedWriter(new FileWriter("InvalidLicenses.csv"));
            BufferedWriter MergedFileWriter = new BufferedWriter(new FileWriter("Merged.csv"));
            ...
            System.out.println("The Valid License generation is successfull");
            System.out.println("The invalid License generation is successfull");
            System.out.println("The Merging is successfull");

            validLicenseWriter.close();
            invalidLicenseWriter.close();
            MergedFileWriter.close();
        } catch (Exception e) {
            System.out.println("The operations are failed");
        }
    }
